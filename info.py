...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'manjappashirattti84-1@okicici</code>')    # Owner UPI ID for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003925777041'))  # Notification of sent to your channel
...
SHORTENER_API = environ.get("SHORTENER_API", "e08a1e2d3d650308344d0fc4d74cb364c1cca5e8") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "papajiuri.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "e08a1e2d3d650308344d0fc4d74cb364c1cca5e8")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "papajiuri.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "e08a1e2d3d650308344d0fc4d74cb364c1cca5e8")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "papajiuri.com") # Shortener website for third website
